$(document).ready(function(){
  ...
  $('.cbox').live('click', function(event){
    ...
    var ht = '<div id="itoutter"><img style="display: block; margin: auto; padding: 70px;" src="https://discover.library.nd.edu/assets/ajax-loader.gif" /></div>';
    var xh = ajHandle();
  ...
  $('.mbox').live('click', function(event){
    ...
    var ht = '<div id="mps"><img style="display: block; margin: auto; padding: 70px;" src="https://discover.library.nd.edu/assets/ajax-loader.gif" /></div>';
    var xh = ajHandle();
    $.colorbox({html:ht, onClosed:function(){ xh.abort(); } });
