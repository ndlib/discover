$(document).ready(function(){
  ...
  $('.cbox').live('click', function(event){
    ...
    var ht = '<div id="itoutter" style="width: 300px; height: 200px;"><img style="width: 70px; display: block; margin: auto; padding-top: 70px;" src="https://discover.library.nd.edu/assets/ajax-loader.gif" /></div>';
    var xh = ajHandle();
  ...
  $('.mbox').live('click', function(event){
    ...
    var ht = '<div id="mps" style="width: 300px; height: 300px;"><img style="width: 70px; display: block; margin: auto; padding-top: 70px;" src="https://discover.library.nd.edu/assets/ajax-loader.gif" /></div>';
    var xh = ajHandle();
    $.colorbox({html:ht, onClosed:function(){ xh.abort(); } });
